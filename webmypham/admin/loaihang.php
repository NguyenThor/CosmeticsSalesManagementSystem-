       ...
       ?>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h2 class="modal-title" id="addModalLabel">Thêm loại hàng</h3>
                                            ...
                                            <form action="loaihangthem.php" method="post">
                                                                    <div class="row">
                                                                        <div class="form-group col-6">
                                                                            <label
                                                                                class="col-form-label font-weight-bold">Tên loại<span class="text-danger"> (*)</span></label>
                                                                            <input type="text" name="L_TEN" class="form-control" placeholder="Nhập tên loại">
                                                                        </div>
        ...
        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
            ...
            ?>
                    ...
                    <td id="kh_ten"><?php echo $row['L_MA']; ?></td>
                        <td><?php echo $row['L_TEN']; ?></td>

                        <td>
                     <span data-toggle="modal" >
                                                    <a href="loaihangsua.php?L_MA=<?php echo $row['L_MA']; ?>" class="text-success" data-toggle="tooltip"
                                                        data-placement="left" data-html="true" title="Sửa"><i
                                                            class="fa fa-edit fa-lg"></i></a>
                    <span data-toggle="modal">
                                                    <a href="loaihangxoa.php?L_MA=<?php echo $row['L_MA']; ?>" class="text-danger ml-3" data-toggle="tooltip"
