    ...
    <div class="header scrolling" id="myHeader">
        <div class="grid wide">
            <div class="header__top">
                ...
                <a href="kh_index.php" class="header__logo">
                    ...
                    <div class="header__search">
                        <div class="header__search-wrap">
                            ...
                            <form name="frmCreate" method="post" action="search.php" class="form"  style="color:white;">
                                <input type="text"  class="header__search-input" name="keyWord" placeholder="Tìm kiếm">
                                
                                <button style="position: absolute; right: 650px;; background-color: transparent; border: none;" name ="search" class="search"><i class="fa fa-search" style="font-size:20px ; color:white;"></i></button>
                            </from>
                ...
                <div  class="sub-nav__link " style="color: rgb(192 132 252);"> 
                ...
                <a href="../index.php" class="sub-nav__link header__cart have"><i  class="fa fa-sign-out" aria-hidden="true"></i></a>
